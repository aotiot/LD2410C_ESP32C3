...
Muuta [LD2410C_ESP32C3.ino](LD2410C_ESP32C3.ino) alussa olevat GPIO-numerot vastaamaan omaa kytkentää:
...
1. Avaa `LD2410C_ESP32C3.ino` Arduino IDE:ssä.
2. Valitse levytyyppi "ESP32C3 Dev Module" (Boards Manager: esp32 by Espressif Systems).
3. Tarkista/muuta GPIO-määrittelyt kytkentää vastaaviksi.
4. Lataa sketch laitteelle.
5. Avaa Serial Monitor 115200 baudilla — tulostuu läsnäolotieto ja UART:sta puretut mittaustiedot 2x sekunnissa.
